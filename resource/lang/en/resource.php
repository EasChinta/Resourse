...
$string['showuser'] = 'Show user who uploaded file';
$string['showuser_desc'] = 'Display user who uploaded the file';
$string['showuser_help'] = 'Display user who uploaded the file';
