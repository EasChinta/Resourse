...
class mod_resource_mod_form extends moodleform_mod {
    function definition() {
        ...
        $mform->addElement('checkbox', 'showuser', get_string('showuser', 'resource'));
        $mform->setDefault('showuser', $config->showuser);
        $mform->addHelpButton('showuser', 'showuser', 'resource');
    ...
    function data_preprocessing(&$default_values) {
        ...
        if (!empty($default_values['displayoptions'])) {
            ...
            if (!empty($displayoptions['showuser'])) {
              $default_values['showuser'] = $displayoptions['showuser'];
            } else {
              $default_values['showuser'] = 0;
            }
        }
    }
